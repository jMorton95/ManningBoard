...
namespace Manning.Api.Migrations
{
    ...
    [Migration("20230706202240_AvatarImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manning.Api.Models.DatabaseModels.AvatarModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Manning.Api.Models.DatabaseModels.AvatarModel", b =>
                {
                    b.HasOne("Manning.Api.Models.Operator", null)
                        .WithOne("Avatar")
                        .HasForeignKey("Manning.Api.Models.DatabaseModels.AvatarModel", "OperatorID");
                });
